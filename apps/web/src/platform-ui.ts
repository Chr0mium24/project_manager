...
function renderMainContent(): string {
  return [
    ...
    "          <div class=\"panel-head\"><div class=\"stack route-copy\"><h2>Project Workspace</h2><p class=\"panel-note workspace-copy\" data-workspace-copy>Focus on one file at a time.</p></div><button type=\"button\" class=\"ghost composer-toggle\" data-workspace-nav-toggle>Focus Editor</button></div>",
    "          <div class=\"workspace-grid\" data-workspace-grid>",
    "            <div data-workspace-nav><div data-file-tree><p>Loading workspace...</p></div></div>",
    ...
    "          <div class=\"panel-head\"><div class=\"stack route-copy\"><h2>Project Versions</h2><p class=\"panel-note\">Review diffs first and open the snapshot composer only when you need a new checkpoint.</p></div><button type=\"button\" class=\"ghost composer-toggle\" data-version-compose-toggle>New Snapshot</button></div>",
    "          <form class=\"stack\" data-version-compose-body hidden>",
